...
export class MaintenanceService {
  ...
  getAllSchedules(params?: {
    ...
    dateFrom?: string;
    dateTo?: string;
  }): Observable<MaintenanceScheduleResponse[]> {
    let httpParams = new HttpParams();
    if (params?.attractionId)
      httpParams = httpParams.set('attractionId', params.attractionId);
    if (params?.status) httpParams = httpParams.set('status', params.status);
    if (params?.dateFrom)
      httpParams = httpParams.set('dateFrom', params.dateFrom);
    if (params?.dateTo) httpParams = httpParams.set('dateTo', params.dateTo);

    return this.http.get<MaintenanceScheduleResponse[]>(
  ...
  getSchedulesByAttraction(
    attractionId: string
  ): Observable<MaintenanceScheduleResponse[]> {
    return this.http.get<MaintenanceScheduleResponse[]>(
      `${this.apiUrl}/schedules/attraction/${attractionId}`
    );
  }

  getOverdueSchedules(): Observable<MaintenanceScheduleResponse[]> {
    return this.http.get<MaintenanceScheduleResponse[]>(
      `${this.apiUrl}/schedules/overdue`
    );
  }
  ...
  getUpcomingSchedules(
    ...
    return this.http.get<MaintenanceScheduleResponse[]>(
      `${this.apiUrl}/schedules/upcoming`,
      { params }
    );
  }
  ...
  updateScheduleStatus(
    ...
    return this.http.put<MessageResponse>(
      `${this.apiUrl}/schedules/${id}/status`,
      request
    );
  }
